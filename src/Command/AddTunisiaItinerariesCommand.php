...
class AddTunisiaItinerariesCommand extends Command
{
    protected static $defaultName = 'app:add-tunisia-itineraries';
    protected static $defaultDescription = 'Add 15 Tunisia itineraries to the database';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($itineraries as $itineraryData) {
            ...
            $io->text("Added itinerary: " . $itineraryData['name']);
        }

        // Flush all changes to the database
        $this->entityManager->flush();
        $io->success("All 15 Tunisia itineraries have been added to the database.");
