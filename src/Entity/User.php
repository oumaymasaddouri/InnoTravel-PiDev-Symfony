...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[Assert\Regex(
        pattern: "/^\+?[0-9\s()-]{6,20}$/",
        message: "Phone number format is invalid. It should include country code."
    )]
    #[ORM\Column(type: "string", length: 255, nullable: true)]
    ...
    #[ORM\OneToMany(mappedBy: "user", targetEntity: Trip::class, cascade: ["remove"])]
    ...
    {
        $roles = $this->roles;
        // Make sure ROLE_USER is always included
