 ...
 */
final class Version20250428105226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, transport_id INT DEFAULT NULL, pickup_address VARCHAR(255) NOT NULL, destination_address VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, estimated_duration INT DEFAULT NULL, sepcial_requests LONGTEXT DEFAULT NULL, INDEX IDX_42C849559909C13F (transport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
